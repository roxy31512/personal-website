      ...
      <header class="site-header">
        <div class="nav-inner container mx-auto px-6 flex items-center justify-between">
          <a class="brand" href="/index.html" aria-label="Home">
            ...
            <img src="https://raw.githubusercontent.com/roxy31512/personal-website/main/images/Profile%20Image.jpg" alt="Roxana Akhmetova" class="w-12 h-12 rounded-full object-cover">
          </a>
